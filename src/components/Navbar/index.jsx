...
const Navbar = () => {
  ...
  after:left-0 hover:after:w-full after:transition-all after:duration-300 items-center  tracking-widest  `;
  ...
  return (
    <nav>
      <div className="w-full h-[4.5rem] flex justify-between items-center bg-[#090b13] opacity-75 fixed">
        ...
        <button className="mr-10 border rounded font-semibold text-base tracking-[0.3rem] border-white px-5 py-1 hover:bg-white hover:text-black">
          LOGIN
        </button>
      </div>
    </nav>
